/*
  Taeshin 578277, Junhyuk KO 531806
 */
...
typedef struct Node
{
    int value;
    syntree_nid next;
    syntree_nid pre_node;
    syntree_nid successor_node;
}Node;
...
extern void
syntreePrintNode(const syntree_t* self, syntree_nid nodeId);

extern int memoryExtension(syntree_t *self);
